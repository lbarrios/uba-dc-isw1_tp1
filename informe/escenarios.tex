...
%Juan había hecho un pedido el lunes a la mañana. A la tarde descubrió mejores precios en los chinos de la vuelta, y 
%decide cancelar la compra para hacerla en ese lugar que le resulta más económico (haciendo las cuentas, le dio que 
%con la diferencia, podía comprar un videojuego para sus hijos). Para eso, vuelve rápido de los chinos a su casa y 
%entusiasmado chequea que aún pueda hacer la cancelación. Para ello ingresa al sitio www.mesporciento.com con su cuenta 
%poniendo sus datos, selecciona el pedido encargado, y al comprobar que no está cerrado,  lo cancela. 
%El sistema le confirma la cancelación. Finalmente Juan vuelve contento a los chinos a hacer la compra y con lo que le 
%sobra, compra el videojuego para sus hijos (aunque como padre responsable, primero lo juega el para enseñarle a ellos!).  

% Modificación de pedido
%En la casa de Brenda van a festejar la navidad. Unas horas después de que había hecho un pedido para preparar la cena, 
%surgió que además de la familia, fueron invitados su amiga Carla con sus hijos para no pasar la navidad solos debido a que 
%el marido de Carla y sus parientes aún no regresaron del exterior por asuntos laborales. Por este motivo, Brenda decide 
%modificar el pedido que tenía hecho incrementando la cantidad de productos comprados como por ejemplo las gaseosas. Para 
%eso entra al sitio www.mesporciento.com ingresando sus datos, chequea que aún no haya sido cerrado dicho pedido, y al 
%comprobarlo selecciona la opción de modificarlo. El sistema le confirma la modificación.               
%¿COMO PAGA LA DIFERENCIA? CREO QUE PONIENDO NUEVAMENTE LOS DATOS DE LA TARJETA, PERO TENGO DUDAS.
%¿HACER ESCENSARIO DONDE QUITA PARTE DEL PEDIDO? EN ESE CASO ¿RECUPERA DIFERENCIA ECONÓMICA?
%LO HICE POR SEPARADO PERO EN REALIDAD ¿MODIFICAR Y CANCELAR PEDIDO ES UNO SOLO?

% ¿UN ESCENARIO CON LO DE ESTADISTICAS NO, NO?

% ¿CORRESPONDE UN ESCENARIO DE REPONER STOCK, CIERTO?  ¿DE PREPARAR Y CERRAR PEDIDO TAMBIEN, NO?

% ¿COMO ERA LO DEL RAITING?

%¿QUE OTROS ESCENARIOS SE PUEDEN PONER? YO ESTO DESPUES LO SIGO PENSANDO



% COMENTARIO A PARTE: No modelamos que una persona pueda consultar (lo hicimos de modo que solo los clientes puedan) ¿No importa?
