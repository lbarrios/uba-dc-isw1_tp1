...
\begin{enumerate}
 ...
 \item Registro presencial cliente
  \begin{enumerate}
      % \item El Cliente se traslada a la Sucursal % No es una interaccion, sino algo q hace el cliente solo. 
      ...
      \item La Sucursal presenta datos de tarjeta del cliente al Agente de Cobro % Revisar que este en el diagrama
 ...
 \item Registro online cliente
  \begin{enumerate}
    ...
    % \item La Financiera evalúa estado financiero del Cliente % no es una interaccion entre los agentes
    % \item El Agente de Cobro valida datos de pago del Cliente % no es una interaccion entre los agentes
 ...
 \item Acuerdo de fecha
  \begin{enumerate}
    % \item Logística le calcula el costo de envío al domicilio al Sistema % no es una interaccion entre los agentes
    \item Si el cliente no recibi\'o alg\'un pedido: 
      ...
      \end{enumerate}
    % \item El Sistema contabiliza ingresos producidos por compras del Cliente % es una operacion interna del sistema
    % \item El Sistema evalúa ingreso generado por influencia social del Cliente % es una operacion interna del sistema
 ...
 \item Entrega fallida
  \begin{enumerate}
    ...
    \item El Sistema reintegra el dinero al Cliente si este no lo recibe. \fixme[SE LO REINTEGRA DIRECTAMENTE?]
 ...
 \item Cierre de sesi\'on
  \begin{enumerate}
    \item Cliente cierra sesión en el Sistema % agregar el evento al Diagrama
    \item Administrador	cierra sesión en el Sistema % agregar el evento al Diagrama
  \end{enumerate}
\end{enumerate}
\clearpage
