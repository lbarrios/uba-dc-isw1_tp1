...
\begin{enumerate}
 ...
 \item Registro presencial cliente
  \begin{enumerate}
      ...
      \item El Agente de Cobro verifica la tarjeta de crédito del Cliente % no es interaccion
      % \item La Sucursal verifica datos personales y de domicilio del Cliente % no es interaccion
      \item La Sucursal carga datos del cliente en el Sistema
      \fixme[Pienso que capaz la Sucursal haga el registro online del cliente con los datos que este le provee, y el sistema haga toda la validaci'on. Y no hacer todo dos veces.]
  \end{enumerate}
